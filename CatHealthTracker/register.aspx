<%@ Page Title="Register" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="CatHealthTracker.User.register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group">
        ...
        <asp:comparevalidator runat="server" controltovalidate="txtPassword" controltocompare="txtConfirm"
            operator="Equal" errormessage="Passwords must be the same" cssclass="label label-danger" />
    </div>
